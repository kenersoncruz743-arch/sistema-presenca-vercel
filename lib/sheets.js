  ...
  // ==================== FUNÇÕES MAPA DE CARGA - PROCESSAMENTO DIRETO ====================
    ...
    async limparColunasMapaCarga() {
      try {
        ...
        const colunasParaLimpar = ['Empresa',	'SM',	'Deposito',	'BOX',	'Carga',	'Coluna 1',	'Descrição',	'sp',	'Ton',	'M³',	'Valor',	'Rup',	'Visita Picking',	'Volume', 	'Coluna 2',
                                   'inclusão',	'Roteirização',	'Geração Mesa',	'"',	'Reposição',	'Palete_Box',	'Baixa',	'Separação',	'Final', 'separação',	'Conferencia',	'seotr'];
