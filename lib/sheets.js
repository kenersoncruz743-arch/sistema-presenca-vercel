...
// FUNÇÃO CORRIGIDA: limparColunasMapaCarga()
// Apenas para substituir no lib/sheets.js
  ...
  async limparColunasMapaCarga() {
    try {
      ...
      // ===== CORREÇÃO: Lista EXATA das 26 colunas a serem limpas =====
      ...
      console.log('[SHEETS] Buscando colunas:', colunasParaLimpar);
      ...
      colunasParaLimpar.forEach(col => {
        ...
        if (idx !== -1) {
          ...
          console.log(`[SHEETS] ✓ Coluna "${col}" encontrada no índice ${idx}`);
        } else {
