  ...
  async getColetoresDoc() {
    if (!this.docColetores) {
      if (!process.env.GOOGLE_SHEETS_ID) {
        throw new Error('GOOGLE_SHEETS_ID não configurado. Configure a variável de ambiente para usar planilha separada.');
      }
      ...
      this.docColetores = new GoogleSpreadsheet(process.env.GOOGLE_SHEETS_ID, serviceAccountAuth);
