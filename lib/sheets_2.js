      ...
      if (!sheetAtual) {
        ...
        try {
          sheetAtual = await this.docAtual.addSheet({
            title: 'Coletor',
            headerValues: ['Chapa', 'Nome', 'Funcao', 'NumeroColetor', 'TipoOpe', 'Situacao', 'Supervisor', 'Data', 'Hora']
          });
          console.log('[SHEETS_COLETOR] ✓ Aba criada com headers: Chapa, Nome, Funcao, NumeroColetor, TipoOpe, Situacao, Supervisor, Data, Hora');
        } catch (createError) {
